...
# Tambahkan impor pustaka yang diperlukan
import os
...
TARGET_GROUP_IDS = [
    ...
    -1001552376990,  # PATUNGAN AKRAB ⬅️ (Grup Pengecualian)
    ...
    -1001197136417,  # 🌐 www.Gatcha.org 🇮🇩 ⬅️ (Grup Pengecualian)
...
# ⚠️ INI YANG HILANG ATAU SALAH KETIK ⚠️
